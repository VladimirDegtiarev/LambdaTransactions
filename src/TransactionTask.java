...
public class TransactionTask {
    public static void main(String[] args) {
        ...
        // дано:
        Stream<Transaction> transactionStream = Stream.of(transaction1, transaction2, transaction3, transaction4, transaction5, transaction6, transaction7);

        // результат: мапа, где String - номер (number) аккаунта, Long - сумма транзакций (sum) по аккаунту

//        System.out.print("Базовый Stream транзакций: ");
//        transactionStream.forEach(System.out::print);

        Map<String, Long> listOfTransactionsByAcc = transactionStream
                .collect(Collectors.groupingBy(Transaction::getAccountNumber, Collectors.summingLong(Transaction::getSum)));

        for(Map.Entry<String, Long> map : listOfTransactionsByAcc.entrySet()){
            System.out.printf("\nAccount %s: Сумма всех транзакций: %d", map.getKey(), map.getValue());
        }
